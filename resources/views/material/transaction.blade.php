        ...
        <div class="col-md-2" style="padding-right: 0">
            <select class="form-control materialColor" name="materialColor[]" required>
                ...
                @foreach($color as $colorAdded)
                    <option value="{{$colorAdded->id}}">{{$colorAdded->name}}</option>
                @endforeach
            </select>
        </div>
