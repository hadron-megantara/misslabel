    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="{{ route('convection.addConvectionList') }}" role="form" id="addForm">
                    {!! csrf_field() !!}

                    <div class="form-group">
                        <label for="convectionListName" class="col-md-4 control-label">Nama Konveksi</label>

                        <div class="col-md-6">
                            <input id="convectionListName" type="text" class="form-control" name="convectionListName" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea id="convectionListDescription" class="form-control" name="convectionListDescription" required style="resize: none;"></textarea>
                        </div>
                    </div>
                </form>
            </div>
...
<div id="convectionListModalEdit" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Ubah Konveksi</h4>
            </div>

            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="{{ route('convection.editConvectionList') }}" role="form" id="editForm">
                    {!! csrf_field() !!}

                    <div class="form-group">
                        <label for="editConvectionListName" class="col-md-4 control-label">Nama Konveksi</label>

                        <div class="col-md-6">
                            <input id="editConvectionListName" type="text" class="form-control" name="convectionListName" required>
                            <input type="hidden" id="editConvectionListId" name="convectionListId" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea id="editConvectionListDescription" class="form-control" name="convectionListDescription" required style="resize: none;"></textarea>
                        </div>
                    </div>
                </form>
            </div>
...
<div id="convectionListModalDelete" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="{{ route('convection.deleteConvectionList') }}" role="form" id="deleteForm">
                    {!! csrf_field() !!}

                    <label>Anda yakin ingin menghapus konveksi "<b id="convectionListDeleteName"></b>" ?</label>
                    <input id="convectionListId" type="hidden" class="form-control" name="convectionListId">
                </form>
            </div>
...
<script type="text/javascript">
	$(document).ready(function(){
        ...
        var t = $('#convectionListTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route('convection.getConvectionList') }}',
            columns: [
                { data: 'name', name: 'name' },
        ...
        $("#convectionListTable").on("click", ".deleteConvectionListBtn", function(){
            var id = this.id;
            id = id.substring(7);
console.log($('#convectionListName_'+id).val());
